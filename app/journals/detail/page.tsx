...
import { FileText, Download, ExternalLink, LogIn, Loader2 } from "lucide-react"
            ...
            if (response.data) {
                ...
                setJournal({
                    ...
                    detailedInfo: response.data.detailedInfo || {
                        founded: response.data.year || "N/A",
                        language: "English",
                        openAccess: "Yes",
                        peerReview: "Double-blind",
                        articleProcessingCharge: "Contact for details",
                        submissionToDecision: "Contact for details",
                        acceptanceToPublication: "Contact for details",
                ...
                setError("Journal data not found. The requested journal may not exist.")
            }
        } catch (err: any) {
                    ...
                    <Card className="max-w-md w-full">
                        <CardHeader>
                            ...
                            <CardDescription className="text-center">
                                {error || "The requested journal could not be found."}
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <Button onClick={fetchJournal} className="w-full">
                                Try Again
                            </Button>
