...
export default function JournalDetailPage() {
  ...
  const redirectParam = encodeURIComponent(`/index.php/${journal.ojs_path}/submission`)
  const directUrl = journal.ojs_path ? `${ojsDomain}/sso_login.php?token=&redirect=${redirectParam}&source=${redirectParam}` : null
