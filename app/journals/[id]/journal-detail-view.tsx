...
export function JournalDetailView({
  ...
  // reconcile activeTab when the prop changes (browser back/forward, or
  // navigating between tabs — each tab is its own route).
  ...
  // Every tab maps to a URL, so selecting one is a soft navigation — the
  // choice is deep-linkable and survives reload / back-forward. The optimistic
  // `setActiveTab` swaps the panel instantly, before the route resolves.
