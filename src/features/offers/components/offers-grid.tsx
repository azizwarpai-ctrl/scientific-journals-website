...
import { useOffers } from "../api/use-offers"
...
export function OffersGrid({ journalId, className }: OffersGridProps) {
  const { data: offers = [], isLoading, isError, error, refetch } = useOffers({ journalId })
